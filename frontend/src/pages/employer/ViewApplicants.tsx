...
// const API_BASE_URL = import.meta.env.REACT_APP_API_URL || 'https://api.yourservice.com';
...
const ApplicantsPage: React.FC = () => {
  ...
  const rootUrl = import.meta.env.BACKEND_ROOT || "http://localhost:3636";
  if(rootUrl == "http://localhost:3636") console.log("local connection");
  ...
  const fetchApplicants = async () => {
    ...
    try {
      const response = await axios.post(`${rootUrl}/v1/application/employer/job/read/applicants`,
        {jobId:jobId},
        {
          headers: {
  ...
  const handleSendAgreement = async () => {
    ...
    try {
      await axios.post(`${rootUrl}/v1/application/employer/job/read/send-agreement`, {
